...
class Menubar:
    def __init__(self, parent):
        font_specs = ("Fira Code", 10)  # Font sang menu.
...
class Lightext:
    def __init__(self, master):
        master.title("Untitled - Lightext by Dion Arquisola")
        master.geometry("1360x760")
        # Ang font sang main workspace.
        font_specs = ("JetBrains Mono", 19)
    ...
    def set_window_title(self, name=None):
        if name:
            self.master.title(name + " - Lightext by Dion Arquisola")
        else:
            self.master.title("Untitled - Lightext")
